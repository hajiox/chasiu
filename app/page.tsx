    ...
    <div className="min-h-screen bg-white">
      ...
      <section id="product" className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          {/* ===== 購入カードの見た目を軽く（画像/文言はそのまま） ===== */}
          {/* Frozen Products */}
          <div className="mb-16">
            <h3 className="text-2xl font-bold text-center mb-8">
              <span className="bg-gradient-to-r from-blue-600 to-sky-400 bg-clip-text text-transparent">冷凍チャーシュー</span>
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-6xl mx-auto">
              <Card className="group overflow-hidden rounded-2xl border border-gray-200 bg-white/80 shadow-sm hover:shadow-lg transition">
                <div className="relative">
                  <div className="h-28 flex items-center justify-center bg-white border-b border-gray-100">
                    <img
          ...
          <div className="mb-16">
            <h3 className="text-2xl font-bold text-center mb-8">
              <span className="bg-gradient-to-r from-amber-600 to-yellow-400 bg-clip-text text-transparent">レトルトチャーシュー</span>
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-6xl mx-auto">
              <Card className="group overflow-hidden rounded-2xl border border-gray-200 bg-white/80 shadow-sm hover:shadow-lg transition">
                <div className="relative">
              ...
              <Card className="group overflow-hidden rounded-2xl border border-gray-200 bg-white/80 shadow-sm hover:shadow-lg transition">
                ...
                <CardContent className="p-5">
                  <h4 className="text-xl font-bold mb-3 text-gray-900">レトルトチャーシュー中厚切り400g（11枚-18枚）</h4>
                  <ul className="text-sm text-gray-700 space-y-2 mb-4">
          ...
          <div>
            ...
            <div className="max-w-sm mx-auto">
              <Card className="group overflow-hidden border border-gray-200 bg-white/90 rounded-2xl shadow-sm hover:shadow-md transition">
                {/* /public/tare.jpg を使用 */}
                <div className="relative aspect-[4/3]">
                  <img
                    src="/tare.jpg"
                ...
                <CardContent className="p-5">
                  ...
                  <p className="mt-4 text-xl md:text-2xl font-bold text-amber-600">1,500円（税・送料込）</p>
                </CardContent>
              </Card>
            </div>
          </div>
              ...
              <Card key={i} className="p-4 md:p-6 bg-white border-gray-200 shadow-sm">
                <div className="flex items-start gap-3 md:gap-4">
                  <img
                    ...
                    width={48}
                    height={48}
                    className="rounded-full w-8 h-8 md:w-12 md:h-12 flex-shrink-0 object-cover"
                    loading="lazy"
                  />
          ...
          <div className="mb-12 md:mb-16">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
              ...
              <a
                ...
                className="block"
              >
                <Card className="group overflow-hidden rounded-2xl border border-pink-200 bg-pink-50 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition">
                  <div className="bg-white p-4 border-b border-pink-100">
                    <img
                  ...
                  <CardContent className="p-5 text-center">
                    <h4 className="font-bold mb-1 text-gray-900">Yahoo!ショッピング</h4>
                    <p className="text-sm text-gray-600">PayPayポイントが貯まる使えるショッピングモールはこちら</p>
                  </CardContent>
                </Card>
              </a>
              ...
              <a
                ...
                className="block"
              >
                <Card className="group overflow-hidden rounded-2xl border border-blue-200 bg-blue-50 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition">
                  ...
                  <CardContent className="p-5 text-center">
                    <h4 className="font-bold mb-1 text-gray-900">楽天市場</h4>
                    <p className="text-sm text-gray-600">楽天ポイントが使える国内最大級のショッピングモールはこちら</p>
                  </CardContent>
                </Card>
              </a>
              ...
              <a
                ...
                className="block"
              >
                <Card className="group overflow-hidden rounded-2xl border border-green-200 bg-green-50 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition">
                  <div className="bg-white p-4 border-b border-green-100">
                    <img
                  ...
                  <CardContent className="p-5 text-center">
                    <h4 className="font-bold mb-1 text-gray-900">Amazon</h4>
                    <p className="text-sm text-gray-600">世界最大のショッピングモールでのお買い物はこちら</p>
                  </CardContent>
                </Card>
              </a>
            </div>
